...
2. Sales of Shampoo - Berupa floating point yang berisi informasi penjualan beer pada Date yang bersesuaian 
...
* Pada file reader, ubah nama kolom Date menjadi enc_datetime dan kolom Sales of Shampoo menjadi reading agar sesuai dengan workflow yang telah diunduh<br/>
...
* Lalu data yang sudah di konversi, di ekstrak bulan dan tahunnya pada node Spark SQL Query dengan syntax dan hasil sebagai berikut<br/>
![SQL date extract](img/sqldateextract.png)<br/>
![Date Extract Result](img/dateextractresult.png)
* Lalu data tersebut di klasifikasi berdasarkan musimnya pada node Spark SQL Query dengan syntax dan hasil sebagai berikut yang pada akhirnya diteruskan sebagai output metanode<br/>
...
* Lalu data tersebut dihitung rata-ratanya per segment yang sesuai (tahun, bulan, dsb..) menggunakan maksimal 3 node yaitu Spark GroupBy, Spark Pivot dan Spark Column Rename 
* Setelah itu, data rata-rata tersebut dijoin menggunakan node Spark Joiner dan diteruskan ke keluar dari metanode
* Selanjutnya, data tersebut dihitung persentase nya per tahun  menggunakan node SQL Spark Query dengan syntax dan hasil sebagai berikut<br/>
